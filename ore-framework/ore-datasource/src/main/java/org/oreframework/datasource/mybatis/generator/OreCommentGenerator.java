package org.oreframework.datasource.mybatis.generator;
...
/**
 * @Title: OreCommentGenerator.java
 * @Description: 自定义数据库注释生成
 * @author Alvin.zengqi  
 * @date 2017年12月27日 下午9:15:39
 * @version V1.0  
 * @Company: Didihu.com.cn
 * @Copyright Copyright (c) 2015
 */
public class OreCommentGenerator implements CommentGenerator{
	...
	public void addConfigurationProperties(Properties properties) {
		...
		if (StringUtility.stringHasValue(dateFormatString)) this.dateFormat = new SimpleDateFormat(dateFormatString);
	}
	...
	protected String getDateString() {
		if (this.suppressDate) return null;
		if (this.dateFormat != null) { return this.dateFormat.format(new Date()); }
	...
	public void addModelClassComment(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
		if ((this.suppressAllComments) || (!(this.addRemarkComments))) { return; }
		StringBuilder sb = new StringBuilder();
	...
	public void addFieldComment(Field field, IntrospectedTable introspectedTable, IntrospectedColumn introspectedColumn) {
	    ...
	    if (introspectedColumn.getRemarks() != null && !introspectedColumn.getRemarks().equals("")) {
	        ...
	        field.addJavaDocLine(" * ".concat(introspectedColumn.getActualColumnName()).concat(":").concat(introspectedColumn.getRemarks()));
	        field.addJavaDocLine(" */");
	    }
	}
